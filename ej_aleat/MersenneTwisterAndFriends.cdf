...
NotebookDataLength[     78049,       1555]
NotebookOptionsPosition[     50925,        972]
NotebookOutlinePosition[     77179,       1533]
CellTagsIndexPosition[     77068,       1527]
WindowTitle->Mersenne Twister and Friends
WindowFrame->Normal*)
...
Cell["Mersenne Twister and Friends", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`method$$ = 11, $CellContext`seed$$ = 
    1, $CellContext`terms$$ = 1000, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`method$$], 11, "randomness method"}, {
      1 -> "Sobol", 2 -> "Niederreiter", 3 -> "MCG31", 4 -> "MCG59", 5 -> 
       "MersenneTwister (MKL)", 6 -> "R250", 7 -> "WichmannHill", 8 -> 
       "ExtendedCA", 9 -> "Rule30CA", 10 -> "Legacy", 11 -> "MersenneTwister",
        12 -> "MKL"}}, {{
       Hold[$CellContext`seed$$], 1, "random seed"}, 1, 1000000, 1}, {{
       Hold[$CellContext`terms$$], 1000, "number of points"}, 100, 10000, 
      100}}, Typeset`size$$ = {360., {178., 182.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`method$1098516$$ = False, $CellContext`seed$1098517$$ =
     0, $CellContext`terms$1098518$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`method$$ = 11, $CellContext`seed$$ = 
        1, $CellContext`terms$$ = 1000}, "ControllerVariables" :> {
        Hold[$CellContext`method$$, $CellContext`method$1098516$$, False], 
        Hold[$CellContext`seed$$, $CellContext`seed$1098517$$, 0], 
        Hold[$CellContext`terms$$, $CellContext`terms$1098518$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> ListPlot[
        BlockRandom[Switch[$CellContext`method$$, 1, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> {"Sobol", "Dimension" -> 2}}], 2, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> {"Niederreiter", "Dimension" -> 2}}], 
           3, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> "MCG31"}], 4, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> "MCG59"}], 5, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> "MersenneTwister"}], 6, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> "R250"}], 7, 
           
           SeedRandom[$CellContext`seed$$, 
            Method -> {"MKL", Method -> "WichmannHill"}], 8, 
           SeedRandom[$CellContext`seed$$, Method -> "ExtendedCA"], 9, 
           SeedRandom[$CellContext`seed$$, Method -> "Rule30CA"], 10, 
           SeedRandom[$CellContext`seed$$, Method -> "Legacy"], 11, 
           SeedRandom[$CellContext`seed$$, Method -> "MersenneTwister"], 12, 
           SeedRandom[$CellContext`seed$$, Method -> "MKL"]]; 
         RandomReal[1, {$CellContext`terms$$, 2}]], AspectRatio -> 1, 
        ImagePadding -> 20], 
      "Specifications" :> {{{$CellContext`method$$, 11, 
          "randomness method"}, {
         1 -> "Sobol", 2 -> "Niederreiter", 3 -> "MCG31", 4 -> "MCG59", 5 -> 
          "MersenneTwister (MKL)", 6 -> "R250", 7 -> "WichmannHill", 8 -> 
          "ExtendedCA", 9 -> "Rule30CA", 10 -> "Legacy", 11 -> 
          "MersenneTwister", 12 -> "MKL"}}, {{$CellContext`seed$$, 1, 
          "random seed"}, 1, 1000000, 
         1}, {{$CellContext`terms$$, 1000, "number of points"}, 100, 10000, 
         100}}, "Options" :> {}, 
...
Cell[TextData[{
 ...
 " comes with a variety of different methods:\n\[Bullet] \
\"Sobol\"\[LongDash]Sobol low-discrepancy sequence\n\[Bullet] \
\"Niederreiter\"\[LongDash]Niederreiter low-discrepancy sequence\n\[Bullet] \
\"MCG31\"\[LongDash]31-bit multiplicative congruential generator\n\[Bullet] \
\"MCG59\"\[LongDash]59-bit multiplicative congruential generator\n\[Bullet] \
\"R250\"\[LongDash]generalized feedback shift register generator\n\[Bullet] \
\"WichmannHill\"\[LongDash]Wichmann\[Dash]Hill combined multiplicative \
congruential generators\n\[Bullet] \"ExtendedCA\"\[LongDash]extended cellular \
automaton generator (default)\n\[Bullet] \"Rule30CA\"\[LongDash]Wolfram rule \
30 generator\n\[Bullet] \"MersenneTwister\"\[LongDash]Mersenne twister shift \
register generator\n\[Bullet] \"MKL\"\[LongDash]Intel MKL generator \
(Intel-based systems)"
}], "ManipulateCaption"],

Cell["\<\
There are two basic types, often identifiable by sight. The pseudorandom \
methods (such as the Mersenne Twister) seem random, while the quasirandom \
methods (such as Sobol) seem to have a pattern, with less clustering. As an \
example of where quasirandom methods might be better, one method for \
estimating the area of a shape is to bound it, then to pick random points \
from that area. Using pseudorandom numbers gives the Monte Carlo method. With \
quasirandom numbers, the method is called quasi-Monte Carlo. Due to the \
relative evenness of the quasirandom methods, sometimes they give better \
estimates.\
\>", "ManipulateCaption",
 CellID->31084472],
...
Cell[TextData[{
 ButtonBox["Random Number",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/RandomNumber.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/RandomNumber.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Random Number Generation",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://reference.wolfram.com/mathematica/tutorial/\
RandomNumberGeneration.html"], None},
  ButtonNote->
...
Cell[TextData[{
 ButtonBox["SeedRandom",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://reference.wolfram.com/mathematica/ref/SeedRandom.html"], None},
  ButtonNote->"http://reference.wolfram.com/mathematica/ref/SeedRandom.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
MersenneTwisterAndFriends&version=0011"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/MersenneTwisterAndFriends/\
MersenneTwisterAndFriends-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Mersenne Twister and Friends",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/MersenneTwisterAndFriends/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/MersenneTwisterAndFriends/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/MersenneTwisterAndFriends/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/MersenneTwisterAndFriends/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/MersenneTwisterAndFriends/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40734, 708, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40995, 717, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[50103, 947, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76783, 1516},
 {"Copyright", 76977, 1521}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[592, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34923, 590, 49, 0, 70, "DemoTitle"],
Cell[34975, 592, 4096, 81, 70, "Output",
 CellID->321582958],
Cell[39074, 675, 983, 18, 70, "ManipulateCaption"],
Cell[40060, 695, 671, 11, 70, "ManipulateCaption",
 CellID->31084472],
Cell[40734, 708, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40995, 717, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41689, 734, 44, 0, 70, "RelatedLinksSection"],
Cell[41736, 736, 628, 21, 70, "RelatedLinks",
 CellID->81393793],
Cell[42367, 759, 890, 30, 70, "RelatedLinks",
 CellID->74934425],
Cell[43260, 791, 835, 27, 70, "RelatedLinks",
 CellID->504502317],
Cell[44098, 820, 4814, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48915, 911, 45, 0, 70, "CitationSection"],
Cell[48963, 913, 816, 20, 70, "Citations"],
Cell[49782, 935, 318, 10, 70, "Author"],
Cell[50103, 947, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature sREhoCDsgG@Y0u75ptC#goZT *)
